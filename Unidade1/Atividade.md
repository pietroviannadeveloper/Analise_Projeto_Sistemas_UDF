Introdução à Análise e Projeto de Sistemas de Informação. Conceitos e elementos fundamentais da engenharia de software - definição, características e tipos de modelagens. Ferramentas Case de apoio ao desenho dos diagramas UML
